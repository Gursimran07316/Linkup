...
import { FaAngleDown, FaUserPlus, FaPlus, FaTrash, FaCog, FaCrown, FaTimes, FaPen, FaLock } from 'react-icons/fa';
...
const ChannelBar = ({ handleKick }) => {
  ...
  return (
    <div className="w-60 bg-gray-850 p-4 bg-gray-800 relative flex flex-col space-y-6 overflow-y-auto">
      ...
      {selectedServer.admin._id === user._id && channel.name.toLowerCase() != 'general' && (
